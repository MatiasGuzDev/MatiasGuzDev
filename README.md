...
| | |
| :--- | :--- |
| <img width="498" height="498" alt="asdsad" src="https://github.com/user-attachments/assets/8189814f-8d5d-4079-a63e-b2a5690d1d1e" />|🚀 **ReMarket**<br>Aplicación multiplataforma diseñada para optimizar el comercio digital. Utilizo **Flutter** para una interfaz fluida y moderna, conectada a un backend robusto en **Python** para la gestión eficiente de datos y procesos.<br><br>🚀**Guzmán e Hijos**<br>Digitalización y optimización de procesos para una empresa de arriendo de maquinaria industrial. Me encargo de la arquitectura del sistema de inventario y la logística operativa para mejorar el servicio al cliente y el control de equipos. | 
